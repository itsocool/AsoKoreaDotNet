...
namespace AsoLibs
{
    ...
    public class AsoActiveXControl : IAsoActiveXControl, IObjectSafety
    {
        ...
        //int IPersistPropertyBag.InitNew()
        //{
        //    MessageBox.Show("IPersistPropertyBag.InitNew");
        //    return 0;
        //}

        //int IPersistPropertyBag.Load(IPropertyBag propertyBag, IntPtr errorLog)
        //{
        //    object parameterVan;
        //    object parameterIp;
        //    object parameterPort;
        //    string van;
        //    string ip;
        //    string port;

        //    propertyBag.Read("van", out parameterVan, errorLog);
        //    propertyBag.Read("ip", out parameterIp, errorLog);
        //    propertyBag.Read("port", out parameterPort, errorLog);

        //    van = (string) parameterVan;
        //    ip = (string) parameterIp;
        //    port = (string) parameterPort;

        //    defaultVan = van;

        //    config.SetValues(van, ip, port);
        //    MessageBox.Show(config.VanProvider);
        //    return 0;
        //}

        //int IPersistPropertyBag.Save(IPropertyBag propertyBag, bool clearDirty, bool saveAllProperties)
        //{
        //    MessageBox.Show(" IPersistPropertyBag.Save");
        //    return 0;
        //}

        //int IPersistPropertyBag.GetClassID(out Guid classID)
        //{
        //    MessageBox.Show("IPersistPropertyBag.GetClassID");
        //    classID = Guid.Empty;
        //    return 0;
        //}
