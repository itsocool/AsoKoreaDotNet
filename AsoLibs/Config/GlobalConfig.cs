    ...
    public sealed class GlobalConfig
    {
        ...
        public void LoadXml()
        {
            try
            {
                ...
                Van = (VANs)Enum.Parse(typeof(VANs), XmlDoc.SelectSingleNode("/config/global/van").InnerText);
        ...
        private void SaveXml()
        {
            try
            {
                ...
                doc.SelectSingleNode("/config/global/van").InnerText = instance.Van.ToString();
        ...
        {
            Van = (van != null) ? (VANs)Enum.Parse(typeof(VANs), van) : instance.Van;
            Ip = ip;
